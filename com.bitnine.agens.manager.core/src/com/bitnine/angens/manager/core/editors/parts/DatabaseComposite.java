 ...
 *
 */
public class DatabaseComposite extends AgensThreadComposite {
	private static final Logger logger = Logger.getLogger(DatabaseComposite.class);
	 ...
	 * @param instance
	 */
	public DatabaseComposite(Composite parent, String title, UserDBDAO userDB, Instance instance) {
	...
	public void refreshUI(List<?> listCpu) {
		...
		try {
			if(listCpu.isEmpty()) {
				...
				Database cpu = (Database)listCpu.get(0);
