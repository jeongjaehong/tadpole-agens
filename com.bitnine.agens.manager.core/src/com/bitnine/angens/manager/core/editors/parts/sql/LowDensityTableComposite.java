 ...
 *
 */
public class LowDensityTableComposite extends AgensTableComposite {
	private static final Logger logger = Logger.getLogger(LowDensityTableComposite.class);
	 ...
	 * @param instance
	 */
	public LowDensityTableComposite(Composite parent, UserDBDAO userDB, Instance instance, AgensMAPLabelProvider labelProvider) {
		super(parent, "Low Density Tables", userDB, instance, labelProvider);
	}
	...
	public void createTableColumn() {
		String[] columnName = {"database", "schema", "table", "tuples", "logical_pages", "physical_pages", "tratio"};
		int[] columnSize = {100, 100, 100, 80, 80, 80, 80};
		int[] align = {SWT.LEFT, SWT.LEFT, SWT.RIGHT, SWT.RIGHT, SWT.RIGHT, SWT.RIGHT, SWT.RIGHT};
