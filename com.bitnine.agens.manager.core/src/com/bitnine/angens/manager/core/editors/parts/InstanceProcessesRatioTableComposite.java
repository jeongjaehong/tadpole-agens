...
//	 * @param instance
//	 */
//	public InstanceProcessesRatioTableComposite(Composite parent, UserDBDAO userDB, Instance instance, LabelProvider labelProvider) {
...
//		int[] columnSize = {80, 80, 80, 80};
//		int[] align = {SWT.RIGHT, SWT.RIGHT, SWT.RIGHT, SWT.RIGHT};
//		
