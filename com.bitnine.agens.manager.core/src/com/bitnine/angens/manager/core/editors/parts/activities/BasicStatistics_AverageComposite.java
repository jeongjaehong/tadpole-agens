...
/**
 * BasicStatistics_Average composite
 * 
 * @author hangum
 *
 */
public class BasicStatistics_AverageComposite extends AgensTableComposite {
	private static final Logger logger = Logger.getLogger(BasicStatistics_AverageComposite.class);
	 ...
	 * @param instance
	 */
	public BasicStatistics_AverageComposite(Composite parent, UserDBDAO userDB, Instance instance, AgensMAPLabelProvider labelProvider) {
		super(parent, "Basic Statistics (Average)", userDB, instance, labelProvider);
	}
	...
	public void createTableColumn() {
		String[] columnName = {"database", "schema", "table", "count", "avg index scans", "avg removed rows", "avg remain rows", "avg duration (sec)", "max duration (sec)"};
