 ...
 *
 */
public class InstanceProcessesTableComposite extends AgensTableComposite {
	 ...
	 * @param instance
	 */
	public InstanceProcessesTableComposite(Composite parent, UserDBDAO userDB, Instance instance, AgensMAPLabelProvider labelProvider) {
