 ...
 *
 */
public class TableComposite extends AgensTableComposite {
	private static final Logger logger = Logger.getLogger(TableComposite.class);
	 ...
	 * @param instance
	 */
	public TableComposite(Composite parent, UserDBDAO userDB, Instance instance, AgensMAPLabelProvider labelProvider) {
		super(parent, "Table", userDB, instance, labelProvider);
	}
	...
	public List<?> getUIData() throws Exception {
		return AgensManagerSQLImpl.getSQLMapQueryInfo(userDB, "table25", getLastSnapId());
	}
	...
	public void createTableColumn() {
		String[] columnName = {"database", "schema", "table", "columns", "MiB", "+MiB", "table scans", "index scans"};
