 ...
 *
 */
public class FunctionsComposite extends AgensTableComposite {
	private static final Logger logger = Logger.getLogger(FunctionsComposite.class);
	 ...
	 * @param instance
	 */
	public FunctionsComposite(Composite parent, UserDBDAO userDB, Instance instance, AgensMAPLabelProvider labelProvider) {
		super(parent, "Functions", userDB, instance, labelProvider);
	}
	...
	public List<?> getUIData() throws Exception {
		return AgensManagerSQLImpl.getSQLMapQueryInfo(userDB, "functions", getLastSnapId());
	}
	...
	public void createTableColumn() {
		String[] columnName = {"database", "schema", "function", "calls", "total time (ms)", "self time (ms)", "time/call (ms)"};
