...
/**
 * Long Transactions composite
 * 
 * @author hangum
 *
 */
public class LongTransactionsComposite extends AgensTableComposite {
	private static final Logger logger = Logger.getLogger(LongTransactionsComposite.class);
	 ...
	 * @param instance
	 */
	public LongTransactionsComposite(Composite parent, UserDBDAO userDB, Instance instance, AgensMAPLabelProvider labelProvider) {
		super(parent, "Long Transactions", userDB, instance, labelProvider);
	}
	...
	public void createTableColumn() {
		...
		String[] columnName = {"pid", "client address", "when to start", "duration (sec)", "query"};
		int[] columnSize = {100, 100, 100, 80, 80};
		int[] align = {SWT.LEFT, SWT.LEFT, SWT.LEFT, SWT.RIGHT, SWT.RIGHT};
